...
NMfit= stan('Google Drive/research/NPP_Model/Regularization_scripts/GAUSstan.stan',init=begin, iter=3000, data=data,chains=3,refresh = 1,control = list(max_treedepth = 10, adapt_delta=.8), sample_file = 'GausNM.csv')
save.image("NMfitGaus.Rdata")  ###Save the whole workspace, not just model fit
