...
CAfit= stan('Google Drive/research/NPP_Model/Regularization_scripts/HSstan.stan', iter=3000, data=data,chains=3,refresh = 1,control = list(max_treedepth = 12, adapt_delta=.95), sample_file = 'horseshoeCA.csv')
save.image("CAfit.Rdata") ###Save the whole workspace, not just model fit
